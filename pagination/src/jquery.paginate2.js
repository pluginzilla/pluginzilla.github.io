/*
    ...
    Description: Pagination to list items and search event
...
(function( $ ) {
    ...
    $.paginate = function(element, options) {
       ...
       plugin.init = function() {
        ...
        if($.inArray('top', plugin.settings.searchInputPosition) > -1) {
            $element.before(searchInputHTML);
        }

        if($.inArray('bottom', plugin.settings.searchInputPosition) > -1) {
            $element.after(searchInputHTML);
        }
    ...
    /*
        #Initliazes plugin
    */
    plugin.drawSearchInput = function() {
